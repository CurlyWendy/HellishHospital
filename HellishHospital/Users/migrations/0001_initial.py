    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(related_name='patient_permissions', to='auth.permission')),
                ('specialization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='specializations', to='Users.specialization')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
